...
class HorizontalGrid(abstract_action_space.AbstractActionSpace):
    ...
    def step(self, state, action):
        ...
        self._action += HorizontalGrid._ACTIONS[action]
    ...
    def random_action(self):
        ...
        return np.random.randint(len(HorizontalGrid._ACTIONS))
