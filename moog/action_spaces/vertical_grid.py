...
class VerticalGrid(abstract_action_space.AbstractActionSpace):
    ...
    def step(self, state, action):
        ...
        self._action += VerticalGrid._ACTIONS[action]
    ...
    def random_action(self):
        ...
        return np.random.randint(len(VerticalGrid._ACTIONS))
